        ...
        <el-col :span="12">
          <el-form class="cadastro-container-form" ref="cadastroForm" :model="formulario" label-width="100px"
            ...
            <el-form-item label="Password" prop="Password" :rules="passwordRules">
              <el-input v-model="formulario.Password" type="password" :show-password="showPassword">
                <template>
                  <i
                    class="el-icon"
            ...
            <el-form-item label="Confirm Password" prop="confirmPassword" :rules="confirmPasswordRules">
              <el-input v-model="formulario.confirmPassword" type="password" :show-password="showPassword">
                <template>
                  <i
                    class="el-icon"
                    :class="showPassword ? 'el-icon-view' : 'el-icon-hide'"
