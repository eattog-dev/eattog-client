...
<template>
  ...
  <section class="menu">
    ...
    <el-row justify="center">
      <el-col :span="20" style="display: inline-block; margin-bottom: 130px;">
        <el-row :gutter="20" justify="start" v-if="cardapio">
          <el-col v-for="dish in cardapio" :xs="24" :sm="12" :md="12" :lg=12 :span="12" @click="exibePratoClicado(dish)">
            <div class="cmp-prato-card">
              <div class="cmp-info-prato">
                <div class="cmp-prato-nome">
                  <h3>{{ dish.nome }}</h3>
                  <p>{{ dish.ingredientes.join(', ') }}</p>
                </div>
                <div class="cmp-prato-valor">
...
.cmp-prato-card:hover {
  transform: scale(1.02);
}

.cmp-prato-card .cmp-info-prato .cmp-prato-nome {
  margin-bottom: 44px;
}

.cmp-prato-card .cmp-info-prato .cmp-prato-nome p {
  color: var(--gray400);
  font-size: 15px;
}

.cmp-prato-card .cmp-imagem-prato img {
  width: 200px;
  height: 100%;
  border-radius: 5px;
}

.cmp-prato-card .cmp-prato-valor .cmp-valor-total-desconto {
  margin-right: 5px;
}

.cmp-prato-card .cmp-prato-valor .cmp-valor-sem-desconto {
